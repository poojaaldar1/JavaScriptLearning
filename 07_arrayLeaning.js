let arrayOfName =[7, 4, 8, 6, 10, 3];//Empty Array
...
let indexOf 7 = arrayOfNumbers.indexOf(4);
...
console.log(`travesing array uding for loop`);
console.log(`----------------------------------------------------------------`);
...
arrayOfNum.push(3); // additing one element Or multiple(3,4,5) in the last
console.log(arrayOfNum);
...
var arrayOfNum = [4, 5, 6, 8, 9, 1];
console.log(arrayOfNum);
arrayOfNum.unshift(77);// additing one element Or multiple(3,4,5) in the start
...
let popResult = arrayOfNum.pop();//removing last element in the array
